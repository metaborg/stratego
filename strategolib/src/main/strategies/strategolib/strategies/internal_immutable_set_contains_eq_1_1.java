...
public class internal_immutable_set_contains_eq_1_1 extends Strategy {
    public static final internal_immutable_set_contains_eq_1_1 instance = new internal_immutable_set_contains_eq_1_1();
    ...
    protected static IStrategoTerm contains(Context context, IStrategoTerm current, IStrategoTerm key, EqualityComparator<Object> cmp) {
