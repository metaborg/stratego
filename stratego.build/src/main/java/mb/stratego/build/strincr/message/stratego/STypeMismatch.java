...
public class STypeMismatch extends StrategoMessage {
    public final IStrategoTerm expected;
    public final IStrategoTerm actual;

    public STypeMismatch(String module, IStrategoTerm locationTerm, IStrategoTerm expected, IStrategoTerm actual,
