...
public class SubFrontend implements TaskDef<SubFrontend.Input, SubFrontend.Output> {
    ...
    public static final class Input implements Serializable {
        ...
        protected Input(String inputFileString, String cifiedName, InputType inputType, IStrategoTerm ast) {
            this(Collections.emptyList(), inputFileString, cifiedName, inputType, ast);
        }

        protected Input(Collection<STask> originTasks, String inputFileString, String cifiedName, InputType inputType, IStrategoTerm ast) {
        ...
        public static Input insertCasts(String cifiedName, IStrategoTerm ast) {
            return new Input(null, cifiedName, InputType.InsertCasts, ast);
        }
    }
