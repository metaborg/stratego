...
public class Spoofax2ParseStratego implements ParseStratego {
    ...
    @Inject public Spoofax2ParseStratego(IResourceService resourceService,
        ILanguageIdentifierService languageIdentifierService, ILanguageService languageService,
        ITermFactory termFactory, ISpoofaxUnitService unitService, ISpoofaxSyntaxService syntaxService,
    ...
    @Override public IStrategoTerm parse(InputStream inputStream, Charset charset, @Nullable String path)
        ...
        if(strategoLangImpl == null) {
            final @Nullable ILanguage strategoLang = languageService.getLanguage(SpoofaxConstants.LANG_STRATEGO_NAME);
