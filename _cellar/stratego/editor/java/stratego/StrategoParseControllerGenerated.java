...
public class StrategoParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Stratego");
  ...
  { 
    StrategoParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = StrategoParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = StrategoParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(StrategoParseControllerGenerated.class);
    }
  ...
  { 
    return StrategoParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
