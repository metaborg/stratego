...
public class TegoParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Tego");
  ...
  { 
    TegoParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TegoParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TegoParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TegoParseControllerGenerated.class);
    }
  ...
  { 
    return TegoParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
